...
class DecodeDetections(Layer):
    ...
    def call(self, y_pred, mask=None):
        ...
        def filter_predictions(batch_item):
            ...
            filtered_single_classes = tf.nest.map_structure(tf.stop_gradient, filtered_single_classes)
        ...
        output_tensor = tf.nest.map_structure(tf.stop_gradient, output_tensor)
